 ...
 * strings the caller derives from `content/trust-forward/copy.ts` and
 * `content/trust-forward/cases.ts` — `PROGRESS.caseLabel(n)` produces
 ...
 * `lib/trust-forward/pointers.ts` against the active path, which is the only
