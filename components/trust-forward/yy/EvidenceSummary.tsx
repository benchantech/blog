import { receiptsByCheckpoint } from "@/lib/trust-forward/yy/receipts";
...
import { EVIDENCE_TAG_INDEX } from "@/content/trust-forward/yy/evidence-tags";
import { deterministicSummaryFraming, learnerWordsBlock } from "@/content/trust-forward/surfaces";
import styles from "./evidence.module.css";

/**
 * Trust Forward Lite — the end of the run (governing addendum
 ...
 * `lib/trust-forward/yy/receipts.ts` or `lib/trust-forward/yy/resonance.ts` and
 ...
 *    `content/trust-forward/yy/` copy module registered in
 *    `TRUST_FORWARD_YY_MODULES`; that module does not exist yet and creating it
