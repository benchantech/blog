...
/**
 * Trust Forward Lite — REFLECT, the one thing a committed record may still
 * gain (governing addendum §3 "REFLECT is a Trust Forward learning step. It is
 ...
 * the same argument `components/trust-forward/ReflectionBox.tsx` makes.
 *
