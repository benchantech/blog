...
/**
 * The one disclosure pattern for the whole of Developer Forward Lite
 ...
 * live in `content/developer-forward/copy.ts` — `INFO_MARKERS`,
 ...
 * `{ id, label, expansion }` records in `content/developer-forward/copy.ts`, so the
