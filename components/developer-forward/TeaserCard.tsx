 ...
 * `gatedCards` in `content/developer-forward/surfaces.ts`).
 *
 ...
 * `content/developer-forward/`. This component never constructs it, and it never
...
export function TeaserCard({
  ...
  ctaLabel: string;
  /**
   * The Full destination, from `content/developer-forward/`. Omit to render the
   ...
   * `df_full_developer_forward_clicked` is one of the seventeen allowlisted events.
