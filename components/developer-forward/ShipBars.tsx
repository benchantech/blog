import { SHIP_AXES, type ShipAxis, type ShipResult } from "@/lib/developer-forward/types";
import { SHIP_AXIS_LABELS } from "@/lib/developer-forward/exports";
 ...
 * `lib/developer-forward/scoring.ts` keeps them as separate fields for the reason
 ...
 * provisionally, and it is registered on `DEVELOPER_FORWARD_ABSENT_BY_DESIGN`
 ...
 * "what is absent and why" — `DEVELOPER_FORWARD_ABSENT_BY_DESIGN` — and re-exported
 ...
 */
export { TODO_SHIP_AXIS_END_LABELS } from "@/content/developer-forward/copy";

/**
 * The exact lean, to the nearest 0.1%.
 *
 * The same formatting `lib/developer-forward/exports.ts` applies to the identical
