...
import type { OptionId } from "@/lib/developer-forward/types";
 ...
 * extraction guide behind `content/developer-forward/cases.ts` states one CRITICAL
 ...
 * told. `selected` is derived from the active path by `lib/developer-forward/
