...
import { LITE_INTRO, PROGRESS } from "@/content/developer-forward/copy";
import { CASE_NUMBERS } from "@/lib/developer-forward/types";
import type { CaseNumber } from "@/lib/developer-forward/types";
import {
  beginRun,
  ...
  yyStorageAvailable,
  emptyYYLedger
} from "@/lib/developer-forward/yy/records";
import type { YYLedger } from "@/lib/developer-forward/yy/records";
import { buildReceipts } from "@/lib/developer-forward/yy/receipts";
import { resonances } from "@/lib/developer-forward/yy/resonance";
import { evidenceTagsForChoiceId } from "@/content/developer-forward/yy/evidence-tags";
import type { YYCase, YYCheckpoint, YYChoice } from "@/lib/developer-forward/yy/types";
import { ActionPill } from "@/components/ui/ActionPill";
import { CheckpointScreen } from "@/components/developer-forward/yy/CheckpointScreen";
import { ChoiceList } from "@/components/developer-forward/yy/ChoiceList";
...
import type { WhyNotStepCopy } from "@/components/developer-forward/yy/WhyNotStep";
 ...
 * `/developer-forward-lite`. The learner's position lives in `localStorage` and in
 ...
 * `lib/developer-forward/yy/records.ts`. There is no second ledger, no "answers"
 ...
 * `content/developer-forward/yy/evidence-tags.ts` keyed by choice id — compiled
 ...
 * (`tests/developer-forward-yy-content.test.ts` diffs them against Ben's source),
 ...
 *
 * THEY STILL BELONG IN `content/developer-forward/yy/`. There is no YY copy module
 ...
 * `components/developer-forward/LiteSandbox.tsx` set the precedent for recording
