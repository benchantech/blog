...
import { closestAlternativeStatement } from "@/lib/developer-forward/yy/receipts";
import type { BenJudgment, ChoiceLabel, YYCheckpoint } from "@/lib/developer-forward/yy/types";
import styles from "./reveal.module.css";

/**
 * Developer Forward Lite — the TIMESTAMP surface for one committed checkpoint
 ...
 * condition — comes from `content/developer-forward/yy/case-*.ts`, and the closest
 * alternative comes from `closestAlternativeStatement()`, which composes
 * content with the eleven-word frame in `lib/developer-forward/yy/receipts.ts`.
      ...
      <div className={styles.yours}>
        ...
        <p className={styles.committed}>
          ...
          {/*
            ...
            `config/developer-forward-lite.v1.json` pins.
          */}
