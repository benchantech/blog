/**
 * Developer Forward Lite — the non-decision learner-facing surfaces: opening
 ...
 * copy, and `content/developer-forward/copy.ts` is where `ben_canonical` copy lives
...
import { FULL_OFFER, LANDING_INCOMPLETE } from "@/content/developer-forward/copy";
...
/**
 * The governance vocabulary every Developer Forward content module tags its groups
...
export const gatedCards: readonly GatedCard[] = [
  {
    id: 1,
    afterCase: 1,
    title: "AI Coach synthesis — Full Developer Forward",
    body: [
      "Lite can remember the choices you made.",
      "Full Developer Forward can interpret the reasoning behind them and use your growing judgment history to decide which real case should challenge you next."
    ],
    ctaLabel: "See full Developer Forward →",
    provenance: "recovered_prior_authoring"
  },
  {
    id: 2,
    afterCase: 2,
    title: "A stronger WHY-NOT — Full Developer Forward",
    body: [
  ...
  },
  {
    ...
    title: "Cross-case pattern synthesis — Full Developer Forward",
    body: [
      "Three fixed cases already create possible patterns.",
      "Full Developer Forward can compare your reasoning across many real cases, propose candidate Playbook principles, expose contradictions, and let you keep, reject, or rewrite them."
    ],
  ...
  },
  {
    id: 4,
    afterCase: 4,
    title: "Mirror your judgment — Full Developer Forward",
    body: [
      "What happens if you’re the developer receiving that level of oversight?",
      "Full Developer Forward can flip stakeholder position, incentives, consequence, authority, and other conditions around your prior reasoning—then see what still survives."
    ],
...
export const finalRevealBlock = {
  ...
  body: [
    "Developer Forward Lite followed rules written in advance.",
...
export const closingUpsell = {
  ...
  fullBridgeLead: "Full Developer Forward does that around a different source:",
  ...
  ctaLabel: "Continue in full Developer Forward →",
  provenance: "recovered_prior_authoring" as SurfaceProvenance,
