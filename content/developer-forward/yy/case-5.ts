/**
 * Developer Forward Lite — CASE 5, "THE HELPER BECOMES THE SYSTEM" (TAKE THE WHEEL).
 *
 * Canonical source: `Developer Forward Lite — YY Method Cases 1–5 Implementation
 ...
 * `docs/developer-forward-compositing-policy.md` — a ruling Ben authorized on
 ...
 * `tests/developer-forward-yy-content.test.ts` fails the build if any decision-layer
 ...
 * a DIFF instead of a tag: `content/developer-forward/yy/approved-blurs.ts` records
