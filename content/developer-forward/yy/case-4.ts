/**
 * Developer Forward Lite — YY Method case 4, "THE ONE-OFF BECOMES THE FOUNDATION".
 *
 * Transcribed from the canonical case source (`Developer Forward Lite — YY Method
 ...
 *
 * WHERE THE SUBSTITUTION RECORD LIVES. `content/developer-forward/yy/approved-blurs.ts`
 * holds the six spans Ben approved on 2026-09-08, span by span; all six fall in
 * cases 1, 3 and 5. `tests/developer-forward-yy-content.test.ts` asserts that Ben's
 ...
 * around it. `docs/developer-forward-compositing-policy.md` still records Ben's
 ...
 * (policy, "The seam"). `tests/developer-forward-yy-content.test.ts` fails the build
