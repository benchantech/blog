import type { ChoiceLabel, EvidenceTag } from "@/lib/developer-forward/yy/types";
import { RESONANCE_THRESHOLD } from "@/lib/developer-forward/yy/types";

/**
 * Developer Forward Lite — the action-evidence-tag taxonomy for the seventeen
 ...
 * `docs/developer-forward-compositing-policy.md`; the tags are
