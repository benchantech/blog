/**
 * The Trust Forward Lite production stamp, v1.1.0 (plan §6.1, gate SC-TF4).
 *
 ...
 * artifact it was derived from, in `content/trust-forward/digests.ts`. Both,
 ...
 * production-version-1.1.0.BEN_APPROVED.json): "Trust Forward Lite production
...
import { TRUST_FORWARD_DIGESTS } from "@/content/trust-forward/digests";
 ...
 * constant and `lib/trust-forward/aggregation.ts` must agree, and a test
 * asserts they do.
 */
...
export const ROUTES = {
  canonical: "/trust-forward",
  publicAlternate: "/trust-forward-lite",
  redirect: "/tf",
 ...
 */
export const SOURCE_DIGESTS = TRUST_FORWARD_DIGESTS;
