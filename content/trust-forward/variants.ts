/**
 * Trust Forward Lite — the 27 world-state axis fragments and the approved
 ...
 * from `@/lib/trust-forward/types` and nothing here redefines any part of it.
 *
...
import type { AxisKey, CaseNumber, Dimension } from "@/lib/trust-forward/types";

/**
 * A CONTRACT GAP, recorded rather than papered over. `AxisKey` in
 * `@/lib/trust-forward/types` declares six keys — `ambiguity`, `reliance`,
