/**
 * Trust Forward Lite — the 33 factual receipt phrases, one per fixed option.
 *
 ...
 * `@/lib/trust-forward/types` is computed from the SHIP axes at result time,
...
import type { DecisionId, OptionId } from "@/lib/trust-forward/types";
