/**
 * Trust Forward Lite — CASE 1, "IT'S JUST A SMALL CHANGE".
 *
 * Transcribed from `Trust Forward Lite — YY Method Cases 1-5 Implementation
 * Source.md` (CASE 1, lines 389-556) under the authorization recorded in
 * `docs/trust-forward-compositing-policy.md` — Ben Chan, 2026-09-08, in
 ...
 * diff. `content/trust-forward/yy/approved-blurs.ts` records the exact six
 * substitutions across all five cases, and
 * `tests/trust-forward-yy-content.test.ts` asserts that Ben's source plus those
