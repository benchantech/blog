/**
 * Trust Forward Lite — CASE 3, "THE LOGIC IS RIGHT" (role: VERIFY).
 *
 * Four checkpoints, transcribed from `Trust Forward Lite — YY Method Cases 1–5
 ...
 *
 * It is registered in `content/trust-forward/yy/approved-blurs.ts` — read that
 ...
 * not live in a tag: `tests/trust-forward-yy-content.test.ts` takes Ben's source,
 ...
 * `docs/trust-forward-compositing-policy.md` is a Ben authorization, not an
