/**
 * Trust Forward Lite - the recovered 729-state terminal narratives, shipped as
 ...
 * trust_forward_lite_729_profiles_SHIP_recalculated.csv`, column
 ...
 * composer must walk `DIMENSIONS` from '@/lib/trust-forward/types'. The trust
...
import type { Dimension } from "@/lib/trust-forward/types";
