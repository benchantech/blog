...
import { SIGNALS, carriesDimension, signalsFor } from "@/content/trust-forward/signals";
import { CASE_AXES, fragmentText } from "@/content/trust-forward/variants";
import {
  SIGNAL_LOOKUP,
  resolveCaseVariant,
  variantIdString,
...
import type { SignalledAnswer } from "@/lib/trust-forward/aggregation";

/**
 * Trust Forward Lite — the recovered signal map and the variant space it opens.
 *
