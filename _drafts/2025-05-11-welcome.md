...
Anyways, if you've found external success but feel an internal pull toward something more lasting, this might be for you. Listen to the podcast first ([yyandme.benchantech.com](https://yyandme.benchantech.com/the-first-echo)). If the work speaks to you, let's build something that echoes forward together.
