/**
 * Trust Forward Lite — the YY Method™ type contract.
 *
 ...
 * (`docs/trust-forward-compositing-policy.md`). Narrative may be composited to
 ...
 * `tests/trust-forward-yy-content.test.ts` fails the build if a choice, a THEN,
...
export interface YYMethodDeclaration {
  ...
  implementation: "trust-forward-case-grammar";
