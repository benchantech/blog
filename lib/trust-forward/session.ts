/**
 * Trust Forward Lite — local sessions and the 6-hour rollover (plan §6.8;
 * ARCHITECTURE.md "Sessions"; `config/trust-forward-lite.v1.json` →
...
import type { LiteDataset } from "@/lib/trust-forward/types";
