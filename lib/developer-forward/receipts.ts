/**
 * Developer Forward Lite — the receipt trail for the active path (plan §6.7).
 *
 ...
 * `@/content/developer-forward/receipts`.
 *
 ...
 * list — `RESULT.receiptsSeeAll` in `@/content/developer-forward/copy` exists for
 * exactly that reason.
 *
...
import { SHIP_WEIGHTS, axisLean } from "@/lib/developer-forward/scoring";
import { signalsFor } from "@/content/developer-forward/signals";
import { receiptPhraseFor } from "@/content/developer-forward/receipts";
