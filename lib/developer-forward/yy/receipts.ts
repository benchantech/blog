/**
 * Developer Forward Lite — deterministic YY receipts (governing addendum
 ...
 * a `.css` specifier. Same discipline as `lib/developer-forward/receipts.ts`, which
...
import type { FrozenJudgment } from "@/lib/developer-forward/yy/records";
 ...
 *   - it is composited under `docs/developer-forward-compositing-policy.md` and
